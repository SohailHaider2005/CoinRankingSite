...
const CryptoDetails = () => {
  ...
  useEffect(() => {
    const fetchData = async() =>{
        try {
            const details = await getCryptoDetails(`coin/${coinId}`)
            setCryptoDetails(details?.data?.coin)
            const history = await getCryptoHistory(`coin/${coinId}/history`,timeperiod)
            console.log(history);
  ...
  if (!cryptoDetails || !coinHistory) return <Loader />;
